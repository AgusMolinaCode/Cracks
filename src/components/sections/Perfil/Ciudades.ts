...
const ciudades: Ciudad[] = [
  ...
  { id: 15, label: "Burzaco", value: "Burzaco" },
  ...
  { id: 45, label: "Longchamps", value: "Longchamps" },
  ...
  { id: 49, label: "Luis Guillón", value: "Luis Guillón" },
  ...
  { id: 66, label: "San Isidro", value: "San Isidro" },
